...
import com.abc.multiVendorEProject.DTOs.securityDtos.AdminStatistics;
import com.abc.multiVendorEProject.DTOs.securityDtos.RoleCreateRequest;
import com.abc.multiVendorEProject.DTOs.securityDtos.RoleUpdateRequest;
...
public class AdminController {
    ...
    public ResponseEntity<User> updateUserRoles(
        ...
        Optional<User> existingUser = userRepository.findByUserNameAndDeletedFalse(username);
